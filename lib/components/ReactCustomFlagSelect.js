...
var ReactCustomFlagSelect = function (_Component) {
  ...
  _createClass(ReactCustomFlagSelect, [{
    ...
    value: function render() {
      ...
      var selectOptionListItemClass = (0, _classnames2.default)(!isTyping && STYLES['select__options-item-show-cursor'], classNameOptionListItem, STYLES['select__options-item'], successMsg && !err && STYLES['success'], disabled && STYLES['disabled']);
