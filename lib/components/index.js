...
var Index = (0, _react.memo)(function (_ref) {
  var _ref$tabIndex = _ref.tabIndex,
      ...
      _ref$id = _ref.id,
      id = _ref$id === void 0 ? (0, _utils.getRandomId)() : _ref$id,
      _ref$name = _ref.name,
  ...
  var selectClass = (0, _utils.cx)(classNameSelect, STYLES['ellipsis']);
  var selectOptionListContainerClass = (0, _utils.cx)(classNameOptionListContainer, STYLES["".concat(TYPE, "__options-container")], show && STYLES['show']);
  ...
  var dropdownIconClass = (0, _utils.cx)(classNameDropdownIconOptionListItem, STYLES["".concat(TYPE, "__dropdown-icon")]);
  var optionListHtml;
  ...
  if (!selectorHtml) {
    ...
    }, item.id, "\xA0"), _react["default"].createElement("div", {
