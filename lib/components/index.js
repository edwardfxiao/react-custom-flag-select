...
exports["default"] = exports.getIndex = exports.getItem = exports.usePrevious = void 0;
...
var Index = (0, _react.memo)(function (_ref) {
  ...
  var prevInternalValue = usePrevious(internalValue);
  ...
  var onKeyDown = (0, _react.useCallback)(function (e) {
    ...
    if (selectKeyList.indexOf(keyCode) !== -1) {
      ...
      var index = -1;
      optionList.forEach(function (i, k) {
        var name = i.name;
