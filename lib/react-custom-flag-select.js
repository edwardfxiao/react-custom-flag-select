(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-custom-flag-select"] = factory(require("react"));
	else
		root["react-custom-flag-select"] = factory(root["React"]);
...
var _reactCustomFlagSelect = __webpack_require__(10);

var _reactCustomFlagSelect2 = _interopRequireDefault(_reactCustomFlagSelect);
...
var ReactCustomFlagSelect = function (_Component) {
  ...
  _createClass(ReactCustomFlagSelect, [{
    ...
    value: function addActive() {
      ...
      item.classList.add(_reactCustomFlagSelect2.default['select__hover-active']);
    }
  }, {
    key: 'removeActive',
    value: function removeActive() {
      ...
      for (var i = 0; i < x.length; i++) {
        x[i].classList.remove(_reactCustomFlagSelect2.default['select__hover-active']);
      }
    }
  }, {
    key: 'pageClick',
    ...
    value: function render() {
      ...
      var wrapperClass = (0, _classnames2.default)(classNameWrapper, _reactCustomFlagSelect2.default['select__wrapper'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var containerClass = (0, _classnames2.default)(classNameContainer, _reactCustomFlagSelect2.default['select__container'], show && _reactCustomFlagSelect2.default['show'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var inputClass = (0, _classnames2.default)(_reactCustomFlagSelect2.default['select__input'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var selectClass = (0, _classnames2.default)(classNameSelect, _reactCustomFlagSelect2.default['ellipsis'], _reactCustomFlagSelect2.default['select__dropdown-menu'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var selectOptionListContainerClass = (0, _classnames2.default)(classNameOptionListContainer, _reactCustomFlagSelect2.default['select__options-container'], show && _reactCustomFlagSelect2.default['show'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var selectOptionListItemClass = (0, _classnames2.default)(!isTyping && _reactCustomFlagSelect2.default['select__options-item-show-cursor'], classNameOptionListItem, _reactCustomFlagSelect2.default['select__options-item'], successMsg && !err && _reactCustomFlagSelect2.default['success'], disabled && _reactCustomFlagSelect2.default['disabled']);

      var dropdownIconClass = (0, _classnames2.default)(classNameDropdownIconOptionListItem, _reactCustomFlagSelect2.default['select__dropdown-icon']);
          ...
          optionListHtml = optionList.map(function (i, k) {
            return _react2.default.createElement(
              'div',
              {
                ...
                className: String(i.id) == String(value) ? selectOptionListItemClass + ' ' + _reactCustomFlagSelect2.default['active'] : '' + selectOptionListItemClass,
                key: k,
      ...
      if (!selectorHtml) {
        selectorHtml = _react2.default.createElement(
          'div',
          { className: _reactCustomFlagSelect2.default['select__dropdown'] },
          flagHtml,
          '\xA0',
          _react2.default.createElement(
            'div',
            { className: _reactCustomFlagSelect2.default['ellipsis'] },
            item.id,
            '\xA0'
          ),
      ...
      return _react2.default.createElement(
        ...
        {
          tabIndex: tabIndex,
          id: _reactCustomFlagSelect2.default['select__wrapper'],
...
module.exports = {"select__wrapper":"react-custom-flag-select__select__wrapper___11lzY","select__input":"react-custom-flag-select__select__input___1s31X","select__container":"react-custom-flag-select__select__container___1WS3q","disabled":"react-custom-flag-select__disabled___1dmK6","select__options-item":"react-custom-flag-select__select__options-item___1CxfE","active":"react-custom-flag-select__active___1tD_D","select__options-container":"react-custom-flag-select__select__options-container___1IX1z","show":"react-custom-flag-select__show___TghHg","select__dropdown":"react-custom-flag-select__select__dropdown___3StfM","select__dropdown-icon":"react-custom-flag-select__select__dropdown-icon___2z384","select__dropdown-icon-container":"react-custom-flag-select__select__dropdown-icon-container___kW1px"};
